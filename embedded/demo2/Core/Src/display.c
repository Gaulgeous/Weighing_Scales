...
//	} else {
//
//		write_number(41, 40, Font_7x10, BLACK, Data->rawADC);
//	}
...
//	} else {
//
//		write_number(41, 66, Font_7x10, BLACK, Data->rawADC);
//	}
...
//	} else {
//
//		write_number(41, 92, Font_7x10, BLACK, Data->rawADC);
//	}
...
void touchProcess(TIM_HandleTypeDef *htim2, ScreenData *data) {
	...
	if (data->frame == WEIGHTING) {
		...
		if (data->xValue < 40) {
			...
			}else if (data->yValue < 56 && data->yValue > 30 && data->xValue > 120) {
			...
			} else if (data->yValue < 82 && data->yValue > 56 && data->xValue > 120) {
			...
			} else if (data->yValue < 110 && data->yValue > 82 && data->xValue > 120) {
