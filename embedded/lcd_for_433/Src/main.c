...
int main(void)
{
  ...
  ILI9163_drawCircle(40, 60,10, ORANGE);
  ...
  while (1)
  {
	...
	if(ILI9341_TouchPressed())
	{
	  ...
	  buffer += 1;
	  sprintf(a, "%d", x);
	  ILI9163_drawString(5, 5, Font_7x10, BLACK, a);
	  ILI9163_drawCircle(x, 128 - y, 10, RED);
	  ILI9163_drawString(5, 20, Font_7x10, BLACK, "HELLO");
	  ILI9163_render();
	}
  }
  /* USER CODE END 3 */
...
static void MX_GPIO_Init(void)
{
  ...
  HAL_GPIO_WritePin(GPIOA, DISP_CS_Pin|ILI9341_TOUCH_CS_Pin|GPIO_PIN_8|DISP_DC_Pin
                          |DISP_RST_Pin, GPIO_PIN_RESET);

  /*Configure GPIO pins : DISP_CS_Pin ILI9341_TOUCH_CS_Pin PA8 DISP_DC_Pin
                           DISP_RST_Pin */
  GPIO_InitStruct.Pin = DISP_CS_Pin|ILI9341_TOUCH_CS_Pin|GPIO_PIN_8|DISP_DC_Pin
                          |DISP_RST_Pin;
